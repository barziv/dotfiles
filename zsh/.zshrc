...
# pnpm
export PNPM_HOME="/Users/barziv/Library/pnpm"
case ":$PATH:" in
  *":$PNPM_HOME:"*) ;;
...
__conda_setup="$('/Users/barziv/miniconda3/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/Users/barziv/miniconda3/etc/profile.d/conda.sh" ]; then
        . "/Users/barziv/miniconda3/etc/profile.d/conda.sh"
    else
        export PATH="/Users/barziv/miniconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
...
export PATH="/Users/barziv/.antigravity/antigravity/bin:$PATH"
